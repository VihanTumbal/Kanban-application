      ...
      <section className="relative min-h-screen flex items-center justify-center px-4 pt-24">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center items-center mb-16 animate-fade-in-up delay-600">
            ...
            <Link
              to="/login"
              className="group flex items-center space-x-2 text-textPrimary border-2 border-border px-8 py-4 rounded-2xl font-bold text-lg hover:border-accent hover:bg-accent/5 transition-all duration-300"
            >
          ...
          <div className="relative animate-fade-in-up delay-800">
            <div className="flex justify-center space-x-4 overflow-hidden">
              <div className="bg-card/60 backdrop-blur-xl border border-border rounded-2xl p-6 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
              ...
              <div className="bg-card/60 backdrop-blur-xl border border-border rounded-2xl p-6 shadow-2xl transform -rotate-2 hover:rotate-0 transition-transform duration-500 mt-8">
              ...
              <div className="bg-card/60 backdrop-blur-xl border border-border rounded-2xl p-6 shadow-2xl transform rotate-1 hover:rotate-0 transition-transform duration-500">
